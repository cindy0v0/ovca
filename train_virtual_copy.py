...
train_transform = trn.Compose([trn.RandomHorizontalFlip(), trn.RandomCrop(32, padding=4), # TODO: augmentation?
...
def train(epoch):
    ...
    for data, target in train_loader:
        ...
        print(f"net returned {x.shape}") # torch.Size([2 x 3 x 512 x 4, 128]) = torch.Size([])
