...
parser.add_argument('--dataset', type=str, choices=['cifar10', 'cifar100', 'ovca'],
                    default='ovca',
...
parser.add_argument('--calibration', '-c', action='store_true',
                    help='Train a model to be used for calibration. This holds out some data for validation.') #TODO
# Optimization options
parser.add_argument('--epochs', '-e', type=int, default=100, help='Number of epochs to train.')                #TODO: 5
parser.add_argument('--learning_rate', '-lr', type=float, default=0.1, help='The initial learning rate.')      #TODO
parser.add_argument('--batch_size', '-b', type=int, default=8, help='Batch size.')
parser.add_argument('--test_bs', type=int, default=8)
parser.add_argument('--momentum', type=float, default=0.9, help='Momentum.')                                   #TODO: help
...
#     split_indicator = f'{args.calibration}'
