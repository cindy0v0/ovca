...
class KimiaNet(nn.Module):
    def __init__(self, num_classes, freeze=True, state_dict_path='/projects/ovcare/classification/cshi/OoD/vos/classification/CIFAR/snapshots/baseline/KimiaNetPyTorchWeights.pth'):
        '''
        ...
        self.model.classifier.bias.data = torch.zeros(size=self.model.fc.bias.size()).cuda()
